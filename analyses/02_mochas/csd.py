...
lmax = 4
cif_dirs = ['csd/S']
# cutoff = spectra.chemenv_cutoff(strategy='simplest') # for chemenv_cutoff, strategy = 'simplest' or 'multi_weights' 
# analysis_name = "csd_AgS_bispectra_lmax_4_simplest_chemenv_cutoff"
